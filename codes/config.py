...
class Config:
    ...
    # Decide the mode of equivariance and invariancenum_models
    equivar_mode = ''
    invar_mode = ''
    ...
    object_label_dir = r'/home/yf/code/Functionalgrasp-main/Data/labeled_data2/use'
    ...
    def save(self):
        ...
        with open(join(self.saving_path, 'parameters.txt'), "w") as text_file:
            ...
            text_file.write('augment_trans = {:f}\n'.format(self.augment_trans))
