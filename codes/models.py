...
class KGEModel(nn.Module, ABC):
                    ...
                    for i in range(batch_size):
                        ...
                        if ranking_test == 1:
                            ...
                            if batch_type == BatchType.HEAD_BATCH:
                                ...
                                print('prediction:', entities_dict.get(entity, entity),
    ...
    #--------------yf-------------------
    @staticmethod
    def test_step1(model, data_reader, mode, args):
        '''
        Evaluate the model on test or valid datasets
        '''
...
def load_entities_dict(file_path):
    ...
    with open(file_path, 'r') as f:
        for line in f:
            ...
            # Assuming the unique identifier is the second string in each line
